    ...
    try {
      ...
      foreach ($postTaxas as $t) {
        ...
        $taxasSanit[] = [
          ...
          'tipo'   => sanitize_text_field($t['tipo'] ?? ''),
          'rotulo_html' => sanitize_text_field($t['rotulo_html'] ?? ''),
        ];
      }
      ...
      $dados = [
        ...
        'totais' => [
          ...
          'caucao'  => floatval($postTotais['caucao'] ?? 0),
          'caucao_rotulo' => sanitize_text_field($postTotais['caucaoRotulo'] ?? ''),
        ],
