...
class BVGN_TariffHistoryAdmin {
  ...
  public static function render(){
    ...
    <style>
      ...
      .bvgn-history-table th:nth-child(3), .bvgn-history-table td:nth-child(3) { white-space: nowrap; text-align: left; }
      .bvgn-history-table th:nth-child(n+4) { min-width: 85px; text-align: right; }
      .bvgn-history-table td:nth-child(n+4) { white-space: nowrap; text-align: right; font-variant-numeric: tabular-nums; }
